...
export const SECTIONS: SectionsContent = {
  ...
  skills: {
    index: '06',
    eyebrow: 'Skills',
    heading: 'An engineering stack built for real products.',
    lede: 'Angular is the foundation. The rest of the stack exists to design, build, test and ship complete products.',
  },
  process: {
    index: '06',

...
## ListTeams
You can execute the `ListTeams` Query using the following Query injector, which is defined in [dataconnect-generated/angular/index.d.ts](./index.d.ts):

```javascript
injectListTeams(options?: ListTeamsOptions, injector?: Injector): CreateDataConnectQueryResult<ListTeamsData, undefined>;
```

### Variables
The `ListTeams` Query has no variables.
### Return Type
Recall that calling the `ListTeams` Query injector returns a `CreateDataConnectQueryResult` object. This object holds the state of your Query, including whether the Query is loading, has completed, or has succeeded/failed, and any data returned by the Query, among other things.
...
To access the data returned by a Query, use the `CreateDataConnectQueryResult.data()` function. The data for the `ListTeams` Query is of type `ListTeamsData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `ListTeams`'s Query injector

```javascript
... // other imports
import { connectorConfig } from '@dataconnect/generated';
import { injectListTeams, ListTeamsOptions } from '@dataconnect/generated/angular'
...
export class MyComponent {
  ...
  query = injectListTeams();

  // You can also pass in an options function (not object) of type `ListTeamsOptions` to the Query injector function.
  options: ListTeamsOptions = () => {
    return {
      staleTime: 5 * 1000
    };
  };
  query = injectListTeams(this.options);
}
```

## ListTasksForTeam
You can execute the `ListTasksForTeam` Query using the following Query injector, which is defined in [dataconnect-generated/angular/index.d.ts](./index.d.ts):

```javascript
injectListTasksForTeam(args: ListTasksForTeamArgs, options?: ListTasksForTeamOptions, injector?: Injector): CreateDataConnectQueryResult<ListTasksForTeamData, ListTasksForTeamVariables>;
```
...
```
### Return Type
Recall that calling the `ListTasksForTeam` Query injector returns a `CreateDataConnectQueryResult` object. This object holds the state of your Query, including whether the Query is loading, has completed, or has succeeded/failed, and any data returned by the Query, among other things.

To check the status of a Query, use the `CreateDataConnectQueryResult.status()` function. You can also check for pending / success / error status using the `CreateDataConnectQueryResult.isPending()`, `CreateDataConnectQueryResult.isSuccess()`, and `CreateDataConnectQueryResult.isError()` functions.

To access the data returned by a Query, use the `CreateDataConnectQueryResult.data()` function. The data for the `ListTasksForTeam` Query is of type `ListTasksForTeamData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `ListTasksForTeam`'s Query injector

```javascript
... // other imports
import { connectorConfig, ListTasksForTeamVariables } from '@dataconnect/generated';
import { injectListTasksForTeam, ListTasksForTeamOptions } from '@dataconnect/generated/angular'
import { DataConnect } from '@angular/fire/data-connect';
import { initializeApp } from '@angular/fire/app';
...
export class MyComponent {
  ...
  listTasksForTeamVars: ListTasksForTeamVariables = {
    teamId: ..., 
  };

  // Since the execution of the query is eager, you don't have to call `execute` to "execute" the Query.
  // Call the Query injector function to get a `CreateDataConnectQueryResult` object which holds the state of your Query.
  query = injectListTasksForTeam(this.listTasksForTeamVars);
  // Variables can be defined inline as well.
  query = injectListTasksForTeam({ teamId: ..., });

  // You can also pass in an options function (not object) of type `ListTasksForTeamOptions` to the Query injector function.
  options: ListTasksForTeamOptions = () => {
    return {
      staleTime: 5 * 1000
    };
  };
  query = injectListTasksForTeam(this.listTasksForTeamVars, this.options);
}
```
...
## CreateTeam
You can execute the `CreateTeam` Mutation using the `CreateDataConnectMutationResult` object returned by the following Mutation injector (which is defined in [dataconnect-generated/angular/index.d.ts](./index.d.ts)):
```javascript
injectCreateTeam(options?: CreateTeamOptions, injector?: Injector): CreateDataConnectMutationResult<CreateTeamData, CreateTeamVariables, CreateTeamVariables>;
```
...
```
### Return Type
Recall that calling the `CreateTeam` Mutation injector returns a `CreateDataConnectMutationResult` object. This object holds the state of your Mutation, including whether the Mutation is loading, has completed, or has succeeded/failed, among other things.
...
To access the data returned by a Mutation, use the `CreateDataConnectMutationResult.data()` function. The data for the `CreateTeam` Mutation is of type `CreateTeamData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `CreateTeam`'s Mutation injector

```javascript
... // other imports
import { connectorConfig, CreateTeamVariables } from '@dataconnect/generated';
import { injectCreateTeam, CreateTeamOptions } from '@dataconnect/generated/angular'
import { DataConnect } from '@angular/fire/data-connect';
import { initializeApp } from '@angular/fire/app';
...
export class MyComponent {
  ...
  mutation = injectCreateTeam();

  // You can also pass in a `CreateTeamOptions` function (not object) to the Mutation injector function.
  options: CreateTeamOptions = () => {
    return {
      onSuccess: () => { console.log('Mutation succeeded!'); }
    };
  };
  mutation = injectCreateTeam(this.options);
  ...
  executeMutation() {
    ...
    this.mutation.mutate(createTeamVars);
    // Variables can be defined inline as well.
    ...
    this.mutation.mutateAsync(createTeamVars);

    // You can also pass in a `CreateTeamOptions` object (not function) to `CreateDataConnectMutationResult.mutate()`.
    this.mutation.mutate(createTeamVars, this.options());
  }
}
```

## CreateTask
You can execute the `CreateTask` Mutation using the `CreateDataConnectMutationResult` object returned by the following Mutation injector (which is defined in [dataconnect-generated/angular/index.d.ts](./index.d.ts)):
```javascript
injectCreateTask(options?: CreateTaskOptions, injector?: Injector): CreateDataConnectMutationResult<CreateTaskData, CreateTaskVariables, CreateTaskVariables>;
```
...
```
### Return Type
Recall that calling the `CreateTask` Mutation injector returns a `CreateDataConnectMutationResult` object. This object holds the state of your Mutation, including whether the Mutation is loading, has completed, or has succeeded/failed, among other things.

To check the status of a Mutation, use the `CreateDataConnectMutationResult.status()` function. You can also check for pending / success / error status using the `CreateDataConnectMutationResult.isPending()`, `CreateDataConnectMutationResult.isSuccess()`, and `CreateDataConnectMutationResult.isError()` functions.

To execute the Mutation, call `CreateDataConnectMutationResult.mutate()`. This function executes the Mutation, but does not return the data from the Mutation. 

To access the data returned by a Mutation, use the `CreateDataConnectMutationResult.data()` function. The data for the `CreateTask` Mutation is of type `CreateTaskData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `CreateTask`'s Mutation injector

```javascript
... // other imports
import { connectorConfig, CreateTaskVariables } from '@dataconnect/generated';
import { injectCreateTask, CreateTaskOptions } from '@dataconnect/generated/angular'
import { DataConnect } from '@angular/fire/data-connect';
import { initializeApp } from '@angular/fire/app';
...
export class MyComponent {
  // Call the Mutation injector function to get a `CreateDataConnectMutationResult` object which holds the state of your Mutation.
  mutation = injectCreateTask();

  // You can also pass in a `CreateTaskOptions` function (not object) to the Mutation injector function.
  options: CreateTaskOptions = () => {
    return {
      onSuccess: () => { console.log('Mutation succeeded!'); }
    };
  };
  mutation = injectCreateTask(this.options);
  ...
  executeMutation() {
    ...
    this.mutation.mutate(createTaskVars);
    // Variables can be defined inline as well.
    this.mutation.mutate({ teamId: ..., title: ..., description: ..., priority: ..., status: ..., dueDate: ..., });

    // You can call `CreateDataConnectMutationResult.mutateAsync()` to execute the Mutation and return a promise with the data returned from the Mutation.
    this.mutation.mutateAsync(createTaskVars);

    // You can also pass in a `CreateTaskOptions` object (not function) to `CreateDataConnectMutationResult.mutate()`.
    this.mutation.mutate(createTaskVars, this.options());
  }
}
```
